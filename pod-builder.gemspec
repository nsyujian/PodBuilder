...
Gem::Specification.new do |spec|
  spec.name          = 'pod-builder-y'
  spec.version       = PodBuilder::VERSION
  spec.authors       = ['nsyujian']
  spec.email         = ['gaoyujian2015@gmail.com']

  spec.summary       = 'Prebuild CocoaPods pods'
  spec.description   = 'Prebuild CocoaPods pods to make compiling your Xcode projects faster'
  spec.homepage      = 'https://github.com/nsyujian/PodBuilder'
